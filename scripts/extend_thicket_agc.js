...
if (false)
  ...
  var l8_images = ee.ImageCollection('LANDSAT/LE07/C01/T1_SR')  //('LANDSAT/LC08/C01/T1_SR')
...
Map.addLayer(masked_image, {min: 0.0, max: 3000, bands: ['B3', 'B2', 'B1'], opacity: 1.0}, 'RGB');
