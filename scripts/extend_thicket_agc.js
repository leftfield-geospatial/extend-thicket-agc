...
// TODO: try s2 sr
// TODO: filter s2 viewing geom (solar and satellite zenith close to 0)
...
var s2_toa_images = ee.ImageCollection('COPERNICUS/S2')
                  ...
                  .filter(ee.Filter.lt('MEAN_SOLAR_ZENITH_ANGLE', 40))
                  .filter(ee.Filter.lt('MEAN_INCIDENCE_ZENITH_ANGLE_B1', 40))
                  .map(s2_cloud_mask)
