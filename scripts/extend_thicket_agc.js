...
// TODO: landsat and better s2 cloud mask - maybe not the shadow projection, but the simple QA0 thing is not working great for S2
...
Map.addLayer(image.divide(10000), {min: 0.0, max: [0.3, 0.3, 0.3], bands: ['B4', 'B3', 'B2'], opacity: 1.0}, 'S2_SR');
Map.addLayer(agc_masked_image.clip(step_arid_and_valley_thicket.geometry(), {min: 0, max: 40, palette: ['red', 'yellow', 'green'], opacity: 1.0}, 'AGC');
