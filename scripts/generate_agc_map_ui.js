...
var textIntro = ui.Label(
    ...
    {fontSize: '14px'});
var textLinkGef = ui.Label('The Baviaanskloof AGC model', {fontSize: '11px'}, 'https://github.com/dugalh/map_thicket_agc');
...
var textGefText = ui.Panel([textIntro, textLinkGef, textPostLinkGef, textInfo], ui.Panel.Layout.Flow('horizontal'));

var toolPanel = ui.Panel([header, textPanel], ui.Panel.Layout.Flow('vertical'), {width: '300px'});
