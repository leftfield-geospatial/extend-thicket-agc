...
print('EE AGC Model: ', agc_dict.model);
...
var ee_agc_model_feat = ee.Feature(thicket_boundary.first().geometry().centroid().geometry(), agc_dict.model);
print(thicket_boundary.first().geometry().centroid().geometry());
